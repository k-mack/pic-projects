...
#define DS18B20_CONVERT_T           0x44 // Initiates temperature conversion
...
#define DS18B20_STATUS_NO_PRESENCE  0x01 // Set when presence signal was not returned by device

typedef struct ds18b20
{
    owire_t *device;        // the DS18B20 1-Wire sensor
    uint8_t scratchpad[9];  // contents read from scratchpad
